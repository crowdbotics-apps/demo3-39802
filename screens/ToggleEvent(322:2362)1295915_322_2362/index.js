...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_322_2365}>
        <View style={styles.View_322_2366}>
          ...
          <View style={styles.View_322_2371}>
            <View style={styles.View_322_2372}>
              <Text style={styles.Text_322_2372}>People</Text>
            </View>
          </View>
          <View style={styles.View_322_2373}>
            <Text style={styles.Text_322_2373}>Events</Text>
          </View>
        </View>
        <View style={styles.View_322_2374}>
          <View style={styles.View_322_2375}>
            <View style={styles.View_322_2376} />
            <View style={styles.View_322_2377}>
          ...
          <View style={styles.View_322_2381}>
            <View style={styles.View_322_2382}>
              <View style={styles.View_322_2383}>
                <View style={styles.View_322_2384} />
        ...
        <View style={styles.View_322_2391}>
          <View style={styles.View_322_2392}>
            <Text style={styles.Text_322_2392}>Discover</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.View_322_2397}>
        ...
        <View style={styles.View_322_2399}>
          <Text style={styles.Text_322_2399}>Come Check me</Text>
        </View>
      </View>
      <View style={styles.View_322_2400}>
        <View style={styles.View_322_2401} />
        <View style={styles.View_322_2402}>
          <Text style={styles.Text_322_2402}>Off to this event</Text>
        </View>
      </View>
      <View style={styles.View_322_2403}>
        <View style={styles.View_322_2404} />
      </View>
      <View style={styles.View_322_2405}>
        <View style={styles.View_322_2406} />
        <View style={styles.View_322_2407}>
      ...
      <View style={styles.View_322_2413}>
        <View style={styles.View_322_2414}>
          ...
          <View style={styles.View_322_2428}>
            <View style={styles.View_322_2429}>
              <View style={styles.View_322_2430} />
              <View style={styles.View_322_2431}>
                <Text style={styles.Text_322_2431}>Pubs</Text>
              </View>
            </View>
            <View style={styles.View_322_2432}>
              <View style={styles.View_322_2433} />
              <View style={styles.View_322_2434}>
                <Text style={styles.Text_322_2434}>Clubs</Text>
              </View>
            </View>
            <View style={styles.View_322_2435}>
              <View style={styles.View_322_2436} />
              <View style={styles.View_322_2437}>
                <Text style={styles.Text_322_2437}>Party</Text>
              </View>
            </View>
            <View style={styles.View_322_2438}>
              <View style={styles.View_322_2439} />
              <View style={styles.View_322_2440}>
                <Text style={styles.Text_322_2440}>Night out</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_322_2441}>
      ...
      <View style={styles.View_322_2443}>
        ...
        <View style={styles.View_322_2447}>
          <View style={styles.View_322_2448}>
      ...
      <View style={styles.View_322_2479}>
        ...
        <View style={styles.View_322_2489}>
          <View style={styles.View_322_2490} />
          <View style={styles.View_322_2491}>
            <Text style={styles.Text_322_2491}>Share</Text>
          </View>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  View_322_2398: {
    ...
    left: wp("0%"),
    top: hp("0%"),
    backgroundColor: "rgba(46, 39, 59, 1)",
  ...
  View_322_2420: {
    ...
    left: wp("0%"),
    top: hp("0%"),
    backgroundColor: "rgba(161, 67, 67, 1)",
    borderTopLeftRadius: 11.179996490478516,
    borderTopRightRadius: 11.179996490478516,
    borderBottomLeftRadius: 0,
    borderBottomRightRadius: 0
  },
  ImageBackground_322_2421: {
    width: wp("93%"),
    minWidth: wp("93%"),
    height: hp("25%"),
    minHeight: hp("25%"),
